	...
	if (root) {
      var style =root.document.createElement("style");
          ...
          var implCss = "#movepopup {box-shadow:10px 10px 5px #888888;" 
          		...
          		+"#movepopup p {padding-top: 2em;padding-right: 0.25em;"
          		+"padding-left: 0.25em;color : black;width: 100%;"
          		+"height: 2em;font-size:14px;text-align : center;font-weight:bold;}"
          		+"#movepopup a{color:navy;border:1px solid navy;float: right;margin-top:0.25em;margin-right:0.25em;"
          		+"border-radius:10%}"+"#movepopup button {color:green;position:relative;display:inline;left:7em;}"
...
//          
           ...
           * 
           */ 
           emergency: function (message,abortCallBack) {
            ...
            * @returns {Object} movepopup namespace
            */
           alert: function (message, abortCallBack) {
               var helper = getHelper(message);
            ...
            * @returns {Object} movepopup namespace
            */
           error: function (message, abortCallBack) {
               var helper = getHelper(message);
            ...
            * @returns {Object} movepopup namespace
            */
           warning: function (message, abortCallBack) {
             var helper = getHelper(message);
            ...
            * @returns {Object} movepopup namespace
            */
           notice: function (message, abortCallBack) {
             var helper = getHelper(message);
            ...
            * @returns {Object} movepopup namespace
            */
           info: function (message, abortCallBack) {
               var helper = getHelper(message);
            ...
            * @returns {Object} movepopup namespace
            */
           debug: function (message, abortCallBack) {
               var helper = getHelper(message);
